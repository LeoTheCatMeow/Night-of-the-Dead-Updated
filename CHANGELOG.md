...
Mini Patch Detail:
- Reverted the Stinger Hold Fire change as people struggle to get used to it. Better implementations may be attempted in the future.
...
- Fixed a bug where attack may remain disabled when supply station restores ammo from 0 to 1 or 2.
